...
class FloodSegmentationDataset(Dataset):
    def __init__(self, root_dir, split='train', size=512, seed=42, num_classes=1):
        self.size = size
        self.seed = seed
...
def get_dataloaders(dataset, batch_size=4, size=256, seed=42, num_classes=1):
    train_dataset = FloodSegmentationDataset(dataset, 'train', size, seed, num_classes)
    val_dataset   = FloodSegmentationDataset(dataset, 'val',   size, seed, num_classes)
    test_dataset  = FloodSegmentationDataset(dataset, 'test',  size, seed, num_classes)
